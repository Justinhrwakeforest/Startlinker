...
from .social_views import (
    ...
    SuggestedUsersViewSet, ProjectTaskViewSet, TaskCommentViewSet, 
    ProjectFileViewSet, ProjectMeetingViewSet, ProjectMilestoneViewSet, 
    CollaborationInviteViewSet
)
...
router.register(r'suggested', SuggestedUsersViewSet, basename='suggestedusers')

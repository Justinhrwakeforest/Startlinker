...
#     user_has_advanced_search, get_user_subscription_limits, get_user_subscription_usage
# )
...
class StartupListSerializer(serializers.ModelSerializer):
    ...
    # Premium features
    user_subscription_limits = serializers.SerializerMethodField()
    user_subscription_usage = serializers.SerializerMethodField()
    can_claim_premium = serializers.SerializerMethodField()
    can_edit_premium = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'user_subscription_limits', 'user_subscription_usage', 'can_claim_premium', 
            'can_edit_premium', 'has_analytics_access', 'has_advanced_search'
        ]
    ...
    def get_user_subscription_limits(self, obj):
        """Get user's subscription limits"""
        # Disabled while subscriptions app is not active
        return None
    
    def get_user_subscription_usage(self, obj):
        """Get user's subscription usage"""
        # Disabled while subscriptions app is not active
        return None
    
    def get_can_claim_premium(self, obj):
        """Check if user can claim startups (subscription-based)"""
        # Disabled while subscriptions app is not active
        return True
    
    def get_can_edit_premium(self, obj):
        """Check if user can edit startups (subscription-based)"""
        # Disabled while subscriptions app is not active
        return True
